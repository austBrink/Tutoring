...
class Customer(Person):
    def __init__(self, name, address, phone_num, cust_num, is_on_mail_list):
        ...
        self.__is_on_mail_list=is_on_mail_list
        
        # set accessor
    def get_cust_num(self):
        return self.__cust_num
    
    def get_is_on_mail_list(self):
        if self.__is_on_mail_list==1:
